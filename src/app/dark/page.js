...
const features = [
  {
    ...
    description: 'We use a variety of channels, including phone, email, and social media, to generate high-quality leads that are most likely to convert into customers.',
...
const secondaryFeatures = [
  {
    ...
    description: 'Our campaigns are designed to generate high-quality leads and appointments that result in increased revenue for our clients.',
    icon: CloudArrowUpIcon,
  },
  {
    name: 'More Efficient Use of Sales Resources',
    description: 'By outsourcing lead generation and appointment setting to us, our client’s sales team can focus on what they do best: closing deals.',
    icon: LockClosedIcon,
  },
  {
    name: 'Expertise',
    description: 'Our team of BDRs has years of experience in the industry and is constantly updating our strategies to ensure that we are delivering the best possible results for our clients.',
    icon: ArrowPathIcon,
  },
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <Image src="/black-transparent.png" width="60" height="60"/>
            </a>
          </div>
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Your Company</span>
                <Image className="h-8 w-auto" src="/black-transparent.png" width="60" height="60"/>
              </a>
              <button
                type="button"
...
{/* Services section */}
<div className="mx-auto mt-2 max-w-7xl px-6 sm:mt-2 lg:px-8 pt-20" id="services">
        ...
        {/* Feature section */}
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8" id="benefits">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-burdgandy">Everything you need</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              ...
              {secondaryFeatures.map((feature) => (
                <div key={feature.name} className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-white">
                    <feature.icon className="h-5 w-5 flex-none text-burdgandy" aria-hidden="true" />
                    {feature.name}
                  </dt>
      ...
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          After accumulating over 15 years of sales experience between the two of us, we decided to combine our knowledge and start a Meetbusters project, under the wings of ‘Incrementum MNE’ ltd. As both of us were responsible for global growth in our previous respective companies, we believe that our experience can bring the best for our clients.
          </p>
        </div>
        <ul
          role="list"
        ...
        >
          {people.map((person) => (
            <li key={person.name}>
              <Image className="mx-auto w-56 h-56 rounded-full" src={person.imageUrl} width={500} height={500} alt="" />
              <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-100">{person.name}</h3>
        ...
        <div className="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="App">
              <InlineWidget url="https://calendly.com/rutesicmiroslav" />
            </div>
          </div>
